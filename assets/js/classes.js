...
class Stage{
    ...
    start(){
        ...
        this.fighter1El.querySelector('.attckButton').addEventListener('click', () => this.doAttack(this.fighter1, this.fighter2))
        this.fighter2El.querySelector('.attckButton').addEventListener('click', () => this.doAttack(this.fighter2, this.fighter1))
    }
    ...
    doAttack(attacking, attacked){
        ...
        if(actualAttack > actualDefense){
            ...
            console.log(`${attacked.name} consegiu defender.....`)
        }
